...
const PerformerReel: React.FC<PerformerReelProps> = ({
  performer,
  isActive,
}) => {
  ...
  const PersonalityScaleBars = () => {
    ...
    const scales = [
      {
        name: "Vocal Strength",
        value: performer.personalityScale.vocalStrength,
        icon: <Mic className="w-4 h-4" />,
      },
      {
        name: "Charisma",
        value: performer.personalityScale.charisma,
        icon: <Star className="w-4 h-4" />,
      },
      {
        name: "Stage Presence",
        value: performer.personalityScale.stagePresence,
        icon: <TrendingUp className="w-4 h-4" />,
      },
      {
        name: "Originality",
        value: performer.personalityScale.originality,
        icon: <Music className="w-4 h-4" />,
      },
      {
        name: "Technical Skill",
        value: performer.personalityScale.technicalSkill,
              ...
              >
                ...
                <div className="mt-3 flex space-x-2">
                  ...
                  <span className="text-xs text-white bg-[#1a1a3a] px-2 py-1 rounded">
                    Wallet:{" "}
                    {`${performer.walletAddress.substring(
                      0,
                      6
                    )}...${performer.walletAddress.substring(
                      performer.walletAddress.length - 4
                    )}`}
                  </span>
                </div>
              </motion.div>
