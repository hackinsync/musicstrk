...
fn test_vote_tracking_functions() {
    ...
    assert(
        voting_mechanism.get_voting_weight(proposal_id, shareholder1) == 0,
    ...
    assert(
        voting_mechanism.get_voting_weight(proposal_id, shareholder1) == 30_u256, 'Weight mismatch',
    );
    assert(
        voting_mechanism.get_voting_weight(proposal_id, shareholder2) == 20_u256, 'Weight mismatch',
    );
}
